...
VENUE_BOOKING_PROGRAMS: Mapping[str, BookingMiniProgram] = {
    ...
    "dsh": DSH_PROGRAM,
    "fsb": FSB_PROGRAM,
    "fsb_shenyun": FSB_PROGRAM,
    "fsb_shekou": FSB_PROGRAM,
    "fsb_xinan": FSB_PROGRAM,
    "fsb_zhengzhong": FSB_PROGRAM,
    "fsb_atuoshan": FSB_PROGRAM,
    "fsb_zonglvquan": FSB_PROGRAM,
    "fsb_guanhu": FSB_PROGRAM,
    "fsb_bantian": FSB_PROGRAM,
    "fsb_shahe": FSB_PROGRAM,
    "fsb_baoshui": FSB_PROGRAM,
    "fsb_nanyou": FSB_PROGRAM,
    "fsb_xinqiao": FSB_PROGRAM,
    "fsb_yifangcheng": FSB_PROGRAM,
    "fsb_qilin": FSB_PROGRAM,
    "fsb_maozhouhe": FSB_PROGRAM,
    "ppba": PPBA_PROGRAM,
    "tyzx": TYZX_PROGRAM,
}

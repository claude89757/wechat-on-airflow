...
class WeChatDeliveryQuiesceTest(unittest.TestCase):
    def test_quiesce_is_scoped_and_preserves_incident_outbox(self):
        ...
        self.assertEqual(len(quiesce_wechat_delivery.WECHAT_DAG_IDS), 25)
        ...
        self.assertIn("expected_paused = 25", script)
        self.assertIn(

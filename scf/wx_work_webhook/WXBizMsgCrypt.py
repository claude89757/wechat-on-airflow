...
<Nonce><![CDATA[%(nonce)s]]></Nonce>
    ...
    def extract(self, xmltext):
        ...
        try:
            ...
            return ierror.WXBizMsgCrypt_OK, encrypt.text, touser_name.text if touser_name is not None else None
        except Exception as e:
            #print(e)
...
class WXBizMsgCrypt(object):
    #构造函数
    #@param sToken: 企业微信上，开发者设置的Token
    # @param sEncodingAESKey: 企业微信上，开发者设置的EncodingAESKey
    # @param sCorpId: 企业微信的CorpId
    ...
    def VerifyURL(self, sMsgSignature, sTimeStamp, sNonce, sEchoStr):
        ...
        ret, echoStr = pc.decrypt(sEchoStr, self.appid)
        return ret, echoStr
